  ...
  methods: {
    ...
    dealSpan () {
      ...
      this.hotWord.forEach((value) => {
        ...
        // spanDom.className = 'sp';
        // spanDom.style.padding = '10px';
        // spanDom.style.borderRadius = '50%';
        // spanDom.style.backgroundColor = this.randomColor();
        // spanDom.style.border = '1px solid' + this.randomColor();
