...
;(function(root, factory) {
  ...
  MLoading.prototype = {
    ...
    initElement: function() {
      ...
      var bodyElement = curtainElement.children('.mloading-body')
      var barElement = bodyElement.children('.mloading-bar')
      var iconElement = barElement.children('.mloading-icon')
      var textElement = barElement.find('.mloading-text')
  ...
  $.fn.mLoading = function(options) {
    var ops = {}; var funName = ''; var funArgs = []
