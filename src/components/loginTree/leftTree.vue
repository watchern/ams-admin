...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      chooseTables: [],
      loadLeftTreeType: "", //因为很多模块需要用到这棵树，用此类型来区分不同模块; 1-SQL编辑器
      isShowLoadLeftTreeBtn: true, //是否展示树操作按钮
  ...
  methods: {
    ...
    handleDragEnd(draggingNode, dropNode, dropType, ev) {
      ...
      // 只有表和字段能拖拽
      if (draggingNode.data.type === "table" || draggingNode.data.type === "table") {
