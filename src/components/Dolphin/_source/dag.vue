...
<template>
  <div class="clearfix dag-model">
    <div class="toolbar">
      <div class="title"><span>'Toolbar'</span></div>
    ...
    <div class="dag-contect">
      <div class="dag-toolbar">
        <div class="assist-btn">
          <x-button style="vertical-align: middle;"
                    data-toggle="tooltip"
          ...
          <span v-if="name"
                class="copy-name"
                @click="_copyName"
                :data-clipboard-text="name"><em class="ans-icon-copy"
                data-container="body"
                data-toggle="tooltip"
                title='Copy name'></em></span>
        </div>
        <div class="save-btn">
          <div class="operation"
          ...
          <x-button v-tooltip.light='Refresh DAG status'
                    data-container="body"
                    style="vertical-align: middle;"
