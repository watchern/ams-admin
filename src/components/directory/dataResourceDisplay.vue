<template>
  <div class="preview_conter padding10_l">
    ...
    <div class="header_search">
      <query-tags ref="tags" @change="onChange"></query-tags>
    ...
    <div class="common_btn" v-if="isBtn == true">
      <div class="click_btn">
        <el-button type="primary" size="small">数据资源导入导出</el-button>
        <div class="show_btn">
          <el-button type="primary" size="small" @click="down_template_dictionary()">模版下载</el-button>
          <el-button type="primary" size="small" @click="Importdata_dictionary()">导入数据资源</el-button>
        </div>
      </div>
      <div class="click_btn">
        <el-button type="primary" size="small">汉化信息导入导出</el-button>
        <div class="show_btn">
          <el-button type="primary" size="small" @click="down_template_cn()">模版下载</el-button>
          <el-button type="primary" size="small" @click="Important_cn()">导入汉化信息</el-button>
        </div>
      </div>
      <div class="click_btn">
        <el-button type="primary" size="small">表关系导入导出</el-button>
        <div class="show_btn">
          <el-button type="primary" size="small" @click="down_template_table()">模版下载</el-button>
          <el-button type="primary" size="small" @click="Important_table()">导入表关系</el-button>
        </div>
      </div>
      <div class="click_btn">
        <el-button type="primary" size="small" @click="sync_data()">同步数据结构</el-button>
      </div>
      <div class="click_btn">
        <el-button type="primary" size="small" @click="Recognition()">认权管理</el-button>
      </div>
      <div class="click_btn">
        <el-button type="primary" size="small" @click="on_register()">注册资源</el-button>
      </div>
      <div class="click_btn">
        <el-button type="primary" size="small" @click="edit_list()">修改</el-button>
      </div>
    </div>

    <el-skeleton style="width:100%;float: left;height: calc(100vh - 270px);overflow: auto;" animated :loading="list_loading" :count="4">
              ...
              <div class="box_ard">
                <div class="conter_list">
                  <div class="box_ard_header _width" @click="on_deails(scope.row)">
                    ...
                    <span class="new_type" v-if="scope.row.tableRelationQuery.tableThemeName">{{ scope.row.tableRelationQuery.tableThemeName }}</span>
                  </div>
                  <div class="new_left padding7">
                    <div class="cover">
                      ...
                      <span class="_title" v-if="scope.row.tableRelationQuery.businessSystemName">{{ scope.row.tableRelationQuery.businessSystemName }}</span>
                    </div>
                  </div>
                  <div class="new_right">
                    <div class="table_type">
                    ...
                    <div class="data_list">
                      ...
                      <span class="data_time" v-if="scope.row.tableRelationQuery.dataDate != null">数据日期：{{ scope.row.tableRelationQuery.dataDate }}</span>
