<template>
  <div class="ztreein" :id="ztreeId"></div>
</template>
...
require("../../lib/@ztree/ztree_v3/js/jquery.ztree.all");
require("../../lib/@ztree/ztree_v3/js/jquery.ztree.exhide");
require("../../lib/ztree/ext/fuzzysearch");
