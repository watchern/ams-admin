      ...
      <form name="files" enctype="multipart/form-data" method="post">
        ...
        >
          <div class="tooltip-info">
            <em class="fa ans-icon-notice-solid" />
          ...
          <m-list-box-f>
            <template slot="name"><strong>*</strong>上传文件</template>
            <template slot="content">
          ...
          <m-list-box-f>
            <template slot="name">文件名称</template>
            <template slot="content">
              <x-input
                v-model="name"
                type="input"
...
import mProgressBar from '@/components/etl/progressBar/progressBar'
import $ from 'jquery'
