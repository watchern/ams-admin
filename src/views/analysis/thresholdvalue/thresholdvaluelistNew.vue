<template>
  <div class="tree-list-container all">
    ...
    <el-row type="flex" class="row-bg">
      <el-col align="right">
        <el-button type="primary" :disabled="btnState.addBtnState" title="添加阈值" class="oper-btn add" @click="addThreshValue" />
        <el-button type="primary" :disabled="btnState.editBtnState" title="修改阈值" class="oper-btn edit" @click="updateThresholdValue" />
        <el-button type="primary" :disabled="btnState.deleteBtnState" titl="删除阈值" class="oper-btn delete" @click="deleteThresholdValue" />
