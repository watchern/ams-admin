<template>
  <div class="app-container">
    ...
    <div>
      ...
      <el-button type="primary" size="mini" :disabled="selections.length === 0" @click="handleUse()">启用</el-button>
      <el-button type="danger" size="mini" :disabled="selections.length === 0" @click="handleBear()">禁用</el-button>
    </div>
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%;"
      ...
      <el-table-column label="排序号" width="300px" align="center" prop="processInstancePriority" />
      <el-table-column label="状态" width="300px" align="center" prop="enableState" :formatter="formatStatus" />
      <el-table-column label="调度任务描述" prop="scheduleDesc" />
      <el-table-column label="最新修改人" width="300px" align="center" prop="updateUserName" />
      <el-table-column label="修改时间" width="300px" align="center" prop="updateTime" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="140px" style="width: 700px; margin-left:50px;">
        ...
        <el-form-item label="作业周期" prop="crontab">
          <el-input v-model="temp.crontab"></el-input>
        </el-form-item>
              ...
              <div slot="content">
                <div class="dep-opt">
                  <a href="javascript:" @click="!isDetails && _addDep()" class="add-dep">
                    <em v-if="!isLoading" class="ans-icon-increase" :class="_isDetails" data-toggle="tooltip" :title="添加"></em>
                    <em v-if="isLoading" class="ans-icon-spinner2 as as-spin" data-toggle="tooltip" :title="添加"></em>
                  </a>
                </div>
                <div class="dep-box">
                  ...
                  <div class="dep-list" v-for="(el,$index) in dependTaskList" :key='$index'>
                    ...
                    <em class="ans-icon-trash dep-delete" data-toggle="tooltip" data-container="body" :class="_isDetails"
                      @click="!isDetails && _deleteDep($index)" :title="删除">
                    </em>
                    <m-depend-item-list :dependTaskList='dependTaskList' v-model="el.dependItemList" @on-delete-all="_onDeleteAll"
                      @getDependTaskList="getDependTaskList" :index="$index">
                    </m-depend-item-list>
                  </div>
                </div>
              </div>
