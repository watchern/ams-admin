        ...
        <el-form-item>
          <div class="dependence-model">
            <m-list-box>
              ...
              <div slot="content">
                <div class="dep-opt">
                  <a href="javascript:" class="add-dep" @click="!isDetails && _addDep()">
                ...
                <div class="dep-box">
                  <span v-if="dependTaskList.length" class="dep-relation" @click="!isDetails && _setGlobalRelation()">
                    {{ relation === 'AND' ? 且 : 或 }}
                  </span>
                  <div v-for="(el,$index) in dependTaskList" :key="$index" class="dep-list">
                    <span v-if="el.dependItemList.length" class="dep-line-pie" @click="!isDetails && _setRelation($index)">
                      {{ el.relation === 'AND' ? 且 : 或 }}
                    </span>
                    <em
