<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="数据角色名称" width="300px" align="center" prop="dataRoleName" />
      <el-table-column label="创建时间" width="300px" align="center" prop="createTime" />
      <el-table-column label="授权方式" width="300px" align="center" prop="authenType" />
      <el-table-column label="数据筛选器状态" prop="filterState" />
      <el-table-column label="数据有效期" prop="timeDuring" />
    </el-table>
