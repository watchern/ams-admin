<template>
  <div>
    <div class="header_Filter padding10">
      <el-row>
        <el-form :inline="true" :model="personalSpace" class="demo-form-inline">
          ...
          <el-form-item label="申请人:">
            <el-input
              v-model="personalSpace.personalSpaceApplication"
              placeholder="申请人"
            ></el-input>
          </el-form-item>
          <el-form-item label="列表类型:">
            <el-select
              v-model="personalSpace.personalSpaceType"
              placeholder="状态选择"
            >
    ...
    <div class="padding10">
      ...
      >
        ...
        <el-table-column
          prop="personalSpaceDate"
          label="申请时间"
          width="150px"
          show-overflow-tooltip
        >
        </el-table-column>
        <el-table-column prop="personalSpaceType" label="状态" width="150px"
          show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="personalSpaceApplication" label="申请人" width="200px"
          show-overflow-tooltip>
        </el-table-column>
        <el-table-column
          prop="viewProcess"
