<template>
  <div class="app-container">
    <el-row>
      <el-col v-if="openType!== 'showTable'"
              align="right">
    ...
    <el-table :data="temp"
      ...
      <el-table-column prop="colName"
        ...
        <template slot-scope="scope">
          <el-select v-model="scope.row.colName"
                     filterable
                     style="width:90%"
                     placeholder="请选择关联列">
      ...
      <el-table-column prop="relTable"
                       label="被关联表">
        <template slot-scope="scope">
          <el-col :span="20">
            <el-input v-model="scope.relationObjectUuid"
                      :disabled="true" />
          </el-col>
