  ...
  <div class="page-container">
    ...
    <el-dialog :title="textMap[dialogStatus]"
        ...
        <div class="detail-form"
          ...
          <el-form ref="dataForm"
            ...
            <el-form-item label="所属系统名称"
                          prop="folderName">
              <el-input v-model="tempObj.folderName"
                        disabled />
            </el-form-item>
            <el-form-item label="数据表名称"
                          prop="displayTbName">
              <el-input v-model="tempObj.displayTbName"
                        disabled />
            </el-form-item>
            <el-form-item label="汉化表名称"
                          prop="chnName">
              <el-input v-model="tempObj.chnName"
                        disabled />
            </el-form-item>
          </el-form>
          <el-table :key="colKey"
      ...
      <div slot="footer">
        <el-button type="primary"
                   size="mini"
                   @click="dialogFormVisibleTable = false">关闭</el-button>
      </div>
    </el-dialog>
    <!-- 弹窗2 导入数据-->
