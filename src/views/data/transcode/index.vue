  ...
  <div class="page-container">
    <div class="pd20">
        ...
        <div class="min-height">
          ...
          <el-form ref="dataForm"
            ...
            <el-form-item label="规则描述："
                          prop="ruleDesc">
              <el-input v-model="temp.ruleDesc"
                        type="textarea" />
            </el-form-item>
            <el-form-item label="转码方式："
                          prop="ruleType">
              <el-radio v-model="temp.ruleType"
                        :label="1"
                        :disabled="dialogStatus === 'update' ? true : false">SQL语句</el-radio>
              <el-radio v-model="temp.ruleType"
                        :label="2"
                        :disabled="dialogStatus === 'update' ? true : false">手动输入</el-radio>
            </el-form-item>
            <el-form-item v-if="temp.ruleType === 1"
                          label="转码规则："
                          prop="sqlContent">
              <div class="mb10">
                <el-link v-if="temp.ruleType === 1"
                         size="mini"
                         type="primary"
                         @click="exSql()">执行SQL</el-link>
              </div>

              <el-input v-model="temp.sqlContent"
                        type="textarea"
                        :placeholder="sqlRuleText" />
            </el-form-item>
            <el-button type="primary"
                       @click="viewSqlRule()"
                       class="btn btn-primary">查看SQL规则</el-button>
            <div v-if="temp.ruleType === 1"
                 :data="sqlRule">
              <el-table>
                <el-table-column prop="codeValue"
                                 label="真实值："
                                 show-overflow-tooltip>
                  <template slot-scope="scope">
                    <el-select ref="codeValue"
                               v-model="scope.row.codeValue"
                               placeholder="请选择真实值">
                      <el-option v-for="(name, index) in colsJson"
                                 :key="index"
                                 :label="name"
                                 :value="name" />
                    </el-select>
                ...
                <el-table-column prop="transValue"
                                 label="显示值："
                                 show-overflow-tooltip>
                  <template slot-scope="scope">
                    <el-select ref="transValue"
                               v-model="scope.row.transValue"
                               placeholder="请选择显示值">
                      <el-option v-for="(name, index) in colsJson"
                                 :key="index"
                                 :label="name"
            ...
            <!-- 执行预览弹窗 -->
            <el-dialog v-if="previewVisible"
                       :visible.sync="previewVisible"
                       width="800px"
                       :modal="false">
              <el-row>
                <el-col>
                  <childTabs ref="childTabs"
          ...
          <el-upload v-if="temp.ruleType === 2"
                     class="upload"
          ...
          <el-table v-if="temp.ruleType === 2"
                    :data="transColRelsData"
                    class="detail-form"
            ...
            <el-table-column prop="codeValue"
              ...
              <template slot-scope="scope">
                ...
                <el-input v-model="scope.row.codeValue"
                          style="width:90%;" />
            ...
            <el-table-column prop="transValue"
              ...
              <template slot-scope="scope">
                <!--            v-if="scope.row.start !='0' || scope.row.start == undefined"-->
                <el-input v-model="scope.row.transValue"
                          style="width:90%;" />
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                <el-link v-if="transColRelsData.length != 1"
                         size="mini"
                         type="danger"
                ...
                <el-link v-if="scope.$index == transColRelsData.length - 1"
                         size="mini"
                         type="primary"
      ...
      <el-dialog :append-to-body="true"
        ...
        <el-input :autosize="{ minRows: 2, maxRows: 5 }"
                  type="textarea"
                  :disabled="true"
                  v-model="sqlRuleText">
        </el-input>
