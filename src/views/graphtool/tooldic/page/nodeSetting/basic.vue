    ...
    <form class="form-horizontal" style="background-color:rgba(0,0,0,0) !important;">
      ...
      <div class="col-sm-12">
        ...
        <div class="control-label col-sm-4 label1" style="text-align: left !important;">
          <input id="isSaveData" type="checkbox" class="form-control" @click="saveData">
          <span class="dataTableNameDiv" style="color: red;">【结果表显示名称：当前登录人名称_输入的结果表名称XXX_当前时间】</span>
        </div>
