                    ...
                    <el-collapse-item title="汇总设置" name="countSet">
                        <el-table id="graphCountNodeTable" :data="items" height="450" style="width: 770px;margin-left: 90px;">
                            ...
                            <el-table-column label="操作" width="180" align="center">
                                <template slot-scope="scope">
                                    <el-button v-if="scope.$index === 0" type="primary" class="oper-btn add-row btn-width-md" @click="addCountTr" style="line-height: normal;"/>
                                    <el-button v-if="scope.$index !== 0" type="primary" class="oper-btn delete-row btn-width-md" @click="delCountTr(scope.$index)" style="line-height: normal;"/>
                                </template>
                            </el-table-column>
                        </el-table>
                    </el-collapse-item>
