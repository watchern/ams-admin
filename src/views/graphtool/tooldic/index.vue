            ...
            <el-table :data="nodeParamArr" height="400" fit ref="nodeParamTable" style="width:100%;">
                ...
                <el-table-column label="操作" width="100" align="center" :resizable="false">
                    <template slot-scope="scope">
                        <el-button type="primary" v-if="!scope.row.hasParamSet" class="oper-btn setting-1" @click="settingParam(scope.row.nodeId,scope.$index)" title="设置参数" style="line-height: normal;"/>
                        <el-button type="primary" v-if="scope.row.hasParamSet" class="oper-btn setting-2" @click="settingParam(scope.row.nodeId,scope.$index)" title="修改参数" style="line-height: normal;"/>
                        <el-button type="primary" v-if="scope.row.hasParamSet" class="oper-btn delete-4" @click="clearSettingParam(scope.row.nodeId,scope.$index)" title="清除参数" style="line-height: normal;"/>
                    </template>
                </el-table-column>
            </el-table>
            <div slot="footer">
