...
EditorUi.prototype.refresh = function (sizeDidChange) {
	...
	this.vsplit.style.left = $(this.sidebarContainer).width() + this.splitSize + "px";//+ $(this.graphToolDiv).offset().left
...
EditorUi.prototype.refreshv = function (sizeDidChange) {
	...
	this.resultContainer.style.height = effVsplitPosition - 60 + "px";
	this.diagramContainer.style.bottom = effVsplitPosition + this.splitSize - 60 + 'px';
...
EditorUi.prototype.createDivs = function () {
	...
	this.resultContainer.style.height = this.resultHeight - 60 + "px";
	...
	this.diagramContainer.style.bottom = this.resultHeight - 60 + "px";
