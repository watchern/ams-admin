...
QueryBuilder.prototype.createRuleFilters = function(rule, container, defaultDir) {
	...
	if("Left" == defaultDir) {
		qbSettings.createRuleFields(container, rule, $("#mainTable" + this.settings.groupNo).val(), defaultDir);
	} else if("Right" == defaultDir) {
		qbSettings.createRuleFields(container, rule, $("#secondTable" + this.settings.groupNo).val(), defaultDir);
	}
  ...
  <div class="rules-group-header"> \
    ...
    <div class="btn-group group-conditions"> \
      {{~ it.conditions: condition }} \
        <label class="btn btn-xs btn-primary" style="display: none;"> \
...
<select class="form-control table-field" name="" style="width: 160px;"> \
  {{~ it.fields: field }} \
